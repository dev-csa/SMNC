...
<div >
	...
	<div id="contents" >
		<div id="pageTitbg">
		<div id="pageTit"><span class="pageTit">Usage by Target</span></div>
		</div>
		<div id="datawrap" >
			<div id="area_graph" >
...
<script>
	...
	function go() {
        ...
        month3 = "'";
		var target = "";
        var url = "json_bytarget.aspx";
        url += "?v0=bytarget&v1=" + sType + "&v3=" + sGender; 
    ...
    function data_result(rcv){
		...
		for(i=0;i<6;i++){
			...
			usage_html += "<td width='7%'>" +value1_user[i]+ "</td><td width='7%'>" +value2_user[i]+ "</td><td width='7%'>" +value3_user[i]+ "</td></tr>";
		}
