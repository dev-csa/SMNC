...
public partial class json_bytarget : System.Web.UI.Page  // 최적화 Optimization 
{
    public string fn = "";
    public string v0 = "";
    public string v1 = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (v1 == "screen") { 
            ...
            title =  "[\"TV\", \"PC\", \"Mobile\", \"스크린별\"]";
        }
        else if(v1 == "digital_chn"){
            type = new string[] {"Youtube", "Naver", "Daum"};
            title =  "[\"Youtube\", \"Naver\", \"Daum\", \"디지털 채널별\"]";
        }
        else if(v1 == "chn_group"){
            type = new string[] {"TV_pub", "TV_cab", "Youtube"};
            title =  "[\"TV(지상파)\", \"TV(종편&케이블)\", \"Youtube\", \"채널 그룹별\"]";                          
        }
        ...
        string sqlWhere = "' AND SEX='" + gender +"' AND AGECD IN(" + age + ") AND MONTH IN(" + month + ")";       
        // 1. 총 이용자수(UV)
        ...
        json = "";
        json += "{ \"title\": " + title;   
        json += ", \"info\":  [\"" + page + "\", \"" + info_target + "\"]";
        json += ", \"dbmonth\":  [" + dbmonth[0] + ", " + dbmonth[1] + ", " + dbmonth[2] + ", " + dbmonth[3] + ", " + dbmonth[4] + ", " + dbmonth[5] + "]";
        json += ", \"value1_uv\":  [" + Math.Round(value1_uv[0]) + ", " + Math.Round(value1_uv[1]) + ", " + Math.Round(value1_uv[2]) + ", " + Math.Round(value1_uv[3]) + ", " + Math.Round(value1_uv[4]) + ", " + Math.Round(value1_uv[5]) + "]";
        json += ", \"value2_uv\":  [" + Math.Round(value2_uv[0]) + ", " + Math.Round(value2_uv[1]) + ", " + Math.Round(value2_uv[2]) + ", " + Math.Round(value2_uv[3]) + ", " + Math.Round(value2_uv[4]) + ", " + Math.Round(value2_uv[5]) + "]";
        json += ", \"value3_uv\":  [" + Math.Round(value3_uv[0]) + ", " + Math.Round(value3_uv[1]) + ", " + Math.Round(value3_uv[2]) + ", " + Math.Round(value3_uv[3]) + ", " + Math.Round(value3_uv[4]) + ", " + Math.Round(value3_uv[5]) + "]";
        json += ", \"value1_tts\":  [" + Math.Round(value1_tts[0]) + ", " + Math.Round(value1_tts[1]) + ", " + Math.Round(value1_tts[2]) + ", " + Math.Round(value1_tts[3]) + ", " + Math.Round(value1_tts[4]) + ", " + Math.Round(value1_tts[5]) + "]";
        json += ", \"value2_tts\":  [" + Math.Round(value2_tts[0]) + ", " + Math.Round(value2_tts[1]) + ", " + Math.Round(value2_tts[2]) + ", " + Math.Round(value2_tts[3]) + ", " + Math.Round(value2_tts[4]) + ", " + Math.Round(value2_tts[5]) + "]";
        json += ", \"value3_tts\":  [" + Math.Round(value3_tts[0]) + ", " + Math.Round(value3_tts[1]) + ", " + Math.Round(value3_tts[2]) + ", " + Math.Round(value3_tts[3]) + ", " + Math.Round(value3_tts[4]) + ", " + Math.Round(value3_tts[5]) + "]";
		json += ", \"value1_time\":  [" + Math.Round(value1_time[0]) + ", " + Math.Round(value1_time[1]) + ", " + Math.Round(value1_time[2]) + ", " + Math.Round(value1_time[3]) + ", " + Math.Round(value1_time[4]) + ", " + Math.Round(value1_time[5]) + "]";
        json += ", \"value2_time\":  [" + Math.Round(value2_time[0]) + ", " + Math.Round(value2_time[1]) + ", " + Math.Round(value2_time[2]) + ", " + Math.Round(value2_time[3]) + ", " + Math.Round(value2_time[4]) + ", " + Math.Round(value2_time[5]) + "]";
        json += ", \"value3_time\":  [" + Math.Round(value3_time[0]) + ", " + Math.Round(value3_time[1]) + ", " + Math.Round(value3_time[2]) + ", " + Math.Round(value3_time[3]) + ", " + Math.Round(value3_time[4]) + ", " + Math.Round(value3_time[5]) + "]";
